...
public class DL_COMMAND_DATA  //Класс разбирает текст команд и предоставляет структурированные данные для выполнения этих команд в диалоговой системе + хранит и обрабатывает команды(управление музыкой).
{
