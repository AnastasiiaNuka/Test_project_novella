...
namespace DIALOGUE
{
    public class Dialogue_Line  //представляет уровень абстракции для обработки и хранения информации о строке диалога, упрощает работу с данными диалоговой системы
    {
