...
public class CommandManager : MonoBehaviour //позволяет управлять выполнением различных команд  и обеспечивает механизм для добавления новых команд с помощью расширений
{
